...
const CONFIG = {
  ...
  // EmailJS Configuration (user needs to fill these)
  EMAILJS: {
    SERVICE_ID: '', // User's EmailJS service ID
    TEMPLATE_ID: '', // User's EmailJS template ID
    PUBLIC_KEY: '', // User's EmailJS public key
    TO_EMAIL: '' // Email to receive notifications
  },
